...
export function HeroPlayerCard() {
  return (
    <div className="mt-8 md:mt-16 w-full max-w-4xl relative perspective-1000">
      {/* Main Card */}
      <div className="relative z-20 bg-[#121212] border border-gray-800 rounded-xl md:rounded-2xl p-4 md:p-6 shadow-2xl animate-float mx-auto max-w-[280px] md:max-w-md">
        ...
        <div className="h-20 md:h-32 bg-gray-900 rounded-lg mb-3 md:mb-4 flex items-center justify-center border border-gray-800 relative overflow-hidden group">
        ...
        <div className="grid grid-cols-3 gap-1.5 md:gap-2 text-center">
          <div className="bg-gray-800/50 rounded p-1.5 md:p-2">
            ...
            <div className="font-bold text-xs md:text-sm text-[#4717F6]">68%</div>
          </div>
          <div className="bg-gray-800/50 rounded p-1.5 md:p-2">
