...
export function ProfileCard({ profile }: ProfileCardProps) {
  ...
  return (
    <div className="mt-10 w-full max-w-4xl relative mx-auto">
      <div className="relative z-20 bg-[#121212] border border-gray-800 rounded-2xl p-6 shadow-2xl mx-auto max-w-md">
        ...
        <div className="grid grid-cols-3 gap-2 text-center">
          <div className="bg-gray-800/50 rounded p-2">
            ...
            <div className="font-bold text-[#4717F6]">{winRateLabel}</div>
          </div>
          <div className="bg-gray-800/50 rounded p-2">
